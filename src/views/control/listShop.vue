  ...
  data() {
    return {
      ...
      list: [
        ...
        { 'a1': '雀巢', 'a2': '淘宝', 'a3': '江西诚信塑料制品批发', 'a4': 'https://item.taobao.com/item.htm?id=575071096502', 'a5': '已下架' },
        { 'a1': '雀巢', 'a2': '淘宝', 'a3': '简绿竹', 'a4': 'https://item.taobao.com/item.htm?id=616756299042', 'a5': '已下架' },
        { 'a1': '雀巢', 'a2': '淘宝', 'a3': '风雨天成', 'a4': 'https://item.taobao.com/item.htm?id=6254848572', 'a5': '已删除' },
        { 'a1': '雀巢', 'a2': '淘宝', 'a3': '三月三的风醉了', 'a4': 'https://item.taobao.com/item.htm?id=43496601982', 'a5': '已下架' },
        { 'a1': '雀巢', 'a2': '淘宝', 'a3': '良法商行', 'a4': 'https://item.taobao.com/item.htm?id=520080242292', 'a5': '已改价' },
        { 'a1': '雀巢', 'a2': '拼多多', 'a3': '安心宝贝', 'a4': 'http://mobile.yangkeduo.com/goods.html?goods_id=109827894342', 'a5': '已删除' },
