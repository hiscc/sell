  ...
  <div class="container">
    ...
    <el-form ref="form" :inline="true" :model="params" label-width="80px" class="form-option">
      ...
      <el-form-item prop="settlementOrderState">
        ...
        <el-date-picker v-model="params.a1" size="small" type="date" value-format="yyyy-MM-dd HH:mm:ss" placeholder="选择日期" style="width: 200px;" clearable />
      </el-form-item>
  ...
  data() {
    return {
      ...
      list: [
        ...
        { 'a1': '雀巢', 'a2': '拼多多', 'a3': '雀巢新星专卖店', 'a4': '拼多多', 'a5': '新星商贸有限公司', 'a6': '上海', 'a7': '王总', 'a8': '微信 wangxinhe098', 'a9': '10/02/2020' },
        { 'a1': '雀巢', 'a2': '拼多多', 'a3': '雀巢大沛专卖店', 'a4': '拼多多', 'a5': '上海大沛实业有限公司', 'a6': '上海', 'a7': '陈总', 'a8': '18839336781', 'a9': '11/02/2020' },
